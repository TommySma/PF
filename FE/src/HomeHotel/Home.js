      ...
      <div className="container" style={{ backgroundColor: 'transparent', borderColor: 'transparent', position: 'relative' }}>
        <div className='row'>
          <div className="left-content col-md-6" style={{ backgroundColor: 'transparent', marginTop: '15%' }}>
            <Link to="/App" className="custom-link btn btn-lg btn-primary" style={{width:'300px' ,backgroundColor: '#556B2F', color: 'white', marginBottom: '15px' }}>VER LISTA DE TAREAS</Link>
            <Link to="/Habitaciones" className="custom-link btn btn-lg btn-primary" style={{width:'300px' ,backgroundColor: '#556B2F', color: 'white', marginTop:'200%' }}>VER HABITACIONES</Link>
          </div>
